...
function switchDemo(demoNumber) {
    ...
    if (demoNumber === 1) {
        video.src = "./videos/demo1.mp4";
        title.textContent = "Civica AI Legal Assistance";
        description.textContent = "Civica is an AI-powered legal app designed to help underprivileged women navigate complex legal challenges.";
    } else if (demoNumber === 2) {
        video.src = "./videos/demo2.mp4";
        title.textContent = "Civica AI Chatbot";
        description.textContent = "A smart chatbot integrated with Civica, helping users get real-time legal support and guidance.";
    }
    video.load();
}