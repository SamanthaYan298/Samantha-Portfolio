...
function updateGallery(title, description, imageUrl) {
    const activeGallery = document.querySelector('.gallery_active');
    if (activeGallery) {
        activeGallery.querySelector('#gallery_title').textContent = title;
        activeGallery.querySelector('#gallery_description').textContent = description;
        activeGallery.querySelector('#gallery_image').style.backgroundImage = `url(${imageUrl})`;
    }
}
...
function resetGallery() {
    const activeGallery = document.querySelector('.gallery_active');
    if (activeGallery) {
        activeGallery.querySelector('#gallery_title').textContent = activeGallery.querySelector('#gallery_title').getAttribute('data-original');
        activeGallery.querySelector('#gallery_description').textContent = activeGallery.querySelector('#gallery_description').getAttribute('data-original');
        activeGallery.querySelector('#gallery_image').style.backgroundImage = `url(${activeGallery.querySelector('#gallery_image').getAttribute('data-original')})`;
    }
}
