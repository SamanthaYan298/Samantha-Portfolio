...
img.addEventListener("mouseleave", () => {
    // Set a short timeout to reset the src back to the original image
    setTimeout(() => {
        img.src = originalSrc;  // Reset to original image after a brief delay
    }, 50);  // You can adjust the delay if necessary (50ms should work)
});
