...
function switchTab(tabId) {
    ...
    tabs.forEach((tab) => {
        tab.classList.remove('nowActive');
    });

    buttons.forEach((button) => {
        button.classList.remove('nowActive');
    });

    document.getElementById(tabId).classList.add('nowActive');
    event.target.classList.add('nowActive');
}