...
function switchCategory(category) {
    ...
    // 迭代每个项目，并根据类别过滤显示或隐藏
    items.forEach(item => {
        const itemCategories = item.getAttribute('data-category').split(' '); // 获取多个类别
    ...
    // 为当前类别的按钮添加 'visible' 类
    const activeButton = document.querySelector(`.btn[onclick="switchCategory('${category}')"]`);
    if (activeButton) {
