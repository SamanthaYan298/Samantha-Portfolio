...
// Select all images in the small_images container
const images = document.querySelectorAll('.small_images img');
...
images.forEach(image => {
    image.addEventListener('click', (e) => {
        ...
        document.getElementById('gallery-image').style.backgroundImage = imageUrl;
    });
});
