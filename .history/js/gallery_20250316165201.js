...
function updateGallery(title, description, imageUrl) {
    ...
    document.getElementById('gallery-image').style.backgroundImage = `url(${imageUrl})`;
}

function resetGallery() {
    document.getElementById('gallery-title').textContent = 'Gallery Title 1';
    document.getElementById('gallery-description').textContent = 'Descriptions';
    document.getElementById('gallery-image').style.backgroundImage = 'url(/images/magazine_images/laptop.jpg)';
}
