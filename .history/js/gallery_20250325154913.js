...
window.onload = () => {
    const img = document.getElementById("image_gif");
    const originalSrc = img.src;  // Get the original image source
    const gifSrc = img.getAttribute("data-gif");  // Get the gif source from data-gif

    console.log("Original Image Source: ", originalSrc);  // Check the initial src
    console.log("GIF Source: ", gifSrc);  // Check the gif src

    img.addEventListener("mouseenter", () => {
        console.log("Mouse Entered: Changing to GIF");
        img.setAttribute("src", gifSrc);  // Change to gif on hover
    });

    img.addEventListener("mouseleave", () => {
        console.log("Mouse Left: Resetting to Original Image");
        img.setAttribute("src", originalSrc);  // Reset to original image after mouse leaves
    });
};
