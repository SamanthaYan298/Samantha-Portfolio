...
document.addEventListener("DOMContentLoaded", () => {
    const curve = document.querySelector(".section .curve");
    ...
    window.addEventListener("scroll", () => {
        ...
        // Animate the curve with scrolling
        const curveOffset = scrollY * 0.1; // Adjust the multiplier for desired movement speed
        curve.style.transform = `translateY(${curveOffset}px)`; // Move the curve
