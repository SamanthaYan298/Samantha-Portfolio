...
const tabs = document.querySelectorAll('.tab');
    ...
    const contentData = {
      chatbot: {
        ...
        title: 'AI Chatbot',
        description: `
          <p>Provides Instant Help</p>
          <p>Chat with the chatbot and navigate challenges with multiple language options through AI-powered legal advice.</p>
        `,
      },
      simplifier: {
        ...
        description: `
          <p>Simplify your documents with AI technology to enhance clarity and save time.</p>
        `,
      },
      support: {
        ...
        title: 'Support Group',
        description: `
          <p>Connect with others and access resources through our dedicated support group.</p>
        `,
      },
    };
    ...
    tabs.forEach(tab => {
      tab.addEventListener('click', () => {
        ...
        // Get the associated tab content data
        const tabKey = tab.dataset.tab;
        const data = contentData[tabKey];

        // Update video and text containers with new content
        videoContainer.innerHTML = data.video;
        textContainer.innerHTML = `<h3>${data.title}</h3>${data.description}`;
      });
    });